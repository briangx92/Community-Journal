    ...
    <?php
		if (isset($_POST['submit'])) {
			...
			if ($msg == "") {
				...
				$insert = "INSERT INTO `users_chat` (`sender_username`, `receiver_username`, `msg_content`, `msg_status`, `msg_date`) VALUES ('$username', '$user_name', '$msg', 'unread', current_timestamp());";
